Game.Level2_easy = function(game){
	this.player = null;
};
...
Game.Level2_easy.prototype = {
	...
	create:function(game){
        ...
        draht5 = game.add.sprite(this.game.width / 2 - 547, 518, 'draht13');
        draht6 = game.add.sprite(this.game.width / 2 - 547, 918, 'draht15');
        draht7 = game.add.sprite(this.game.width / 2 - 547, 1118, 'draht12');
        draht8 = game.add.sprite(this.game.width / 2 - 429, 1118, 'draht16');
        draht9 = game.add.sprite(this.game.width / 2 - 229, 1118, 'draht14');
        draht10 = game.add.sprite(this.game.width / 2 + 171, 1118, 'draht10');
        draht11 = game.add.sprite(this.game.width / 2 + 171, 1236, 'draht13');
        draht12 = game.add.sprite(this.game.width / 2 + 171, 1402, 'draht13');
        ziel = game.add.sprite(this.game.width / 2 + 171, this.game.height - 118, 'ziell');
        ...
        //show current level
        levelText = this.add.text(1204, this.game.height / 2 - 160, 'LEVEL 2 [EINFACH]', { fill: "#454545", font: "45px Arial" });
        levelText.angle = 90;
