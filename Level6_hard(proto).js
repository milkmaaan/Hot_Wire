...
Game.Level2_hard.prototype = {
	...
	create:function(game){
        ...
        //add wood for background and black for status bar
        this.game.add.tileSprite(0, 0, 1000, 1920, 'black');
        ...
        einfachIcon = this.game.add.sprite(1200, this.game.height / 2 - 130, "schwerIcon");
        ...
        good = game.add.sprite(this.game.width / + 495, 1660, 'gruen');
