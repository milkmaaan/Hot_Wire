Game.Level3_easy = function(game){
	this.player = null;
};
...
Game.Level3_easy.prototype = {
	...
	create:function(game){
        ...
        draht7 = game.add.sprite(this.game.width / 2 + 288, 718, 'draht11');
        draht8 = game.add.sprite(this.game.width / 2 - 112, 718, 'draht14');
        draht9 = game.add.sprite(this.game.width / 2 - 230, 718, 'draht9');
        draht10 = game.add.sprite(this.game.width / 2 - 230, 836, 'draht13');
        draht11 = game.add.sprite(this.game.width / 2 - 230, 1236, 'draht12');
        draht12 = game.add.sprite(this.game.width / 2 - 112, 1236, 'draht16');
        draht13 = game.add.sprite(this.game.width / 2 + 88, 1236, 'draht10');
        draht14 = game.add.sprite   (this.game.width / 2 + 88, 1354, 'draht13');
        draht15 = game.add.sprite(this.game.width / 2 + 88, 1402, 'draht13');
        ziel = game.add.sprite(this.game.width / 2 + 88, this.game.height - 118, 'ziell');
        ...
        //show current level
        levelText = this.add.text(1204, this.game.height / 2 - 160, 'LEVEL 3 [EINFACH]', { fill: "#454545", font: "45px Arial" });
        levelText.angle = 90;
