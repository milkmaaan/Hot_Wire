...
Game.Level6_hard.prototype = {
	...
	update:function(){
        ...
        else if (this.checkOverlap(sprite, ziel))
		{
            ...
            if (localStorage.getItem('level6_hardhd') === null) {
                ...
                localStorage.setItem('level6_hardhd', counter);
            } else if (localStorage.getItem('level6_hardhd') > counter) {
                //neuer Highscore
                localStorage.setItem('level6_hardhd', counter);
            }
		}
    ...
    pauseMessageBox(w = 1050, h = 1512) {
        ...
        var trophytime = this.game.add.sprite(0, 0, "trophytimehard6");
    ...
    doneMessageBox(w = 1050, h = 1512) {
        ...
        var doneText2 = this.game.add.text(0, 0, "Bestzeit: "+ localStorage.getItem('level6_hardhd') + " Sekunden", style2);
