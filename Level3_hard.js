...
Game.Level3_hard.prototype = {
	...
	update:function(){
        ...
        else if (this.checkOverlap(sprite, ziel))
		{
            ...
            if (localStorage.getItem('level3_hardhd') === null) {
                ...
                localStorage.setItem('level3_hardhd', counter);
            } else if (localStorage.getItem('level3_hardhd') > counter) {
                //neuer Highscore
                localStorage.setItem('level3_hardhd', counter);
            }
		}
    ...
    doneMessageBox(w = 1050, h = 1512) {
        ...
        var doneText2 = this.game.add.text(0, 0, "Bestzeit: "+ localStorage.getItem('level3_hardhd') + " Sekunden", style2);
