...
Game.Level3_hard.prototype = {
	...
	create:function(game){
        ...
        draht4 = game.add.sprite(this.game.width / 2 + 29, 200, 'draht6');
        draht5 = game.add.sprite(this.game.width / 2 + 429, 200, 'draht2');
        draht6 = game.add.sprite(this.game.width / 2 + 429.5, 259, 'draht7');
        draht7 = game.add.sprite(this.game.width / 2 + 429.5, 459, 'draht3');
        ...
        //show current level
        levelText = this.add.text(1204, this.game.height / 2 - 160, 'LEVEL 3 [SCHWER]', { fill: "#454545", font: "45px Arial" });
        levelText.angle = 90;
    ...
    doneMessageBox(w = 1050, h = 1512) {
        ...
        var highscoretxt = this.game.add.text(0, 0, "Dein Highscore: " + localStorage.getItem('level3_hard') +" Sekunden", style2);
