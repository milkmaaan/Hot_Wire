...
Game.Level5_hard.prototype = {
	...
	create:function(game){
        ...
        draht8 = game.add.sprite(this.game.width / 2 + 235, 429.5, 'draht8');
	...
	update:function(){
        ...
        else if (this.checkOverlap(sprite, ziel))
		{
            ...
            if (localStorage.getItem('level5_hardhd') === null) {
                ...
                localStorage.setItem('level5_hardhd', counter);
            } else if (localStorage.getItem('level5_hardhd') > counter) {
                //neuer Highscore
                localStorage.setItem('level5_hardhd', counter);
            }
		}
    ...
    pauseMessageBox(w = 1050, h = 1512) {
        ...
        var trophytime = this.game.add.sprite(0, 0, "trophytimehard5");
    ...
    doneMessageBox(w = 1050, h = 1512) {
        ...
        var doneText2 = this.game.add.text(0, 0, "Bestzeit: "+ localStorage.getItem('level5_hardhd') + " Sekunden", style2);
