...
Game.Level5_hard.prototype = {
	...
	create:function(game){
        ...
        draht8 = game.add.sprite(this.game.width / 2 + 229.5, 429.5, 'draht8');
        draht9 = game.add.sprite(this.game.width / 2 + 429, 429.5, 'draht2');
        draht10 = game.add.sprite(this.game.width / 2 + 429, 488, 'draht5');
        draht11 = game.add.sprite(this.game.width / 2 + 429, 888, 'draht5');
        draht12 = game.add.sprite(this.game.width / 2 + 429, 1288, 'draht3');
        ...
        //show current level
        levelText = this.add.text(1204, this.game.height / 2 - 160, 'LEVEL 5 [SCHWER]', { fill: "#454545", font: "45px Arial" });
        levelText.angle = 90;
